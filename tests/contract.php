...
$required = [
    ...
    'function createEnvelopeEmbeddedSession(' => "/embedded-sessions",
    'function getEnvelopeEmbeddedSessions(' => "/embedded-sessions",
    'function recordEnvelopeDeliveryProof(' => "/delivery-proofs",
